...
#create new table under the database 4119db
...
insert into customer values('A07','sana','saifi','SA',2565335,'2001-01-16','1540');

#display the data in the table
select*from customer;

# update the phone number of coustomer A02 and A04
update customer set Phone='2767262' where Cust_id='A02';
update customer set Phone='74624563' where Cust_id='A04';
...
VALUES ('A07', 'amit', 'singh', 'SA', '672566235', '1992-03-23', '500.00'),
 ...
 #delete single row
delete from customer  where Cust_id ='A08';